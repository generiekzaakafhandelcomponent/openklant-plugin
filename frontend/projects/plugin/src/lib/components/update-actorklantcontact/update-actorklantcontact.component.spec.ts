...
import {UpdateActorKlantcontactComponent} from './update-actorklantcontact.component';
import {UpdateActorKlantcontactConfig} from '../../models/update-actorklantcontact-config';

describe('UpdateActorKlantcontactComponent', () => {
    let component: UpdateActorKlantcontactComponent;
    let fixture: ComponentFixture<UpdateActorKlantcontactComponent>;
    let save$: Subject<void>;

    const emptyConfig = {
        uuid: '',
        resultPvName: '',
    } satisfies Partial<UpdateActorKlantcontactConfig>;
    const validConfig = {...emptyConfig, uuid: 'x', resultPvName: 'x'} satisfies Partial<UpdateActorKlantcontactConfig>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [UpdateActorKlantcontactComponent]
        })
            .overrideTemplate(UpdateActorKlantcontactComponent, '')
            .compileComponents();

        save$ = new Subject<void>();

        fixture = TestBed.createComponent(UpdateActorKlantcontactComponent);
        component = fixture.componentInstance;

        component.save$ = save$;
        component.disabled$ = of(false);
        component.pluginId = 'openklant';
        component.prefillConfiguration$ = of(emptyConfig as UpdateActorKlantcontactConfig);
