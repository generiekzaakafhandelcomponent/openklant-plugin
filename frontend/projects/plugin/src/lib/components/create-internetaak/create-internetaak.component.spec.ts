...
import {CreateInterneTaakComponent} from './create-internetaak.component';
import {CreateInterneTaakConfig} from '../../models/create-internetaak-config';

describe('CreateInterneTaakComponent', () => {
    let component: CreateInterneTaakComponent;
    let fixture: ComponentFixture<CreateInterneTaakComponent>;
    ...
    const emptyConfig = {
        ...
        status: '',
        resultPvName: '',
    } satisfies Partial<CreateInterneTaakConfig>;
    const validConfig = {...emptyConfig, gevraagdeHandeling: 'x', klantcontactUuid: 'x', status: 'x', resultPvName: 'x'} satisfies Partial<CreateInterneTaakConfig>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [CreateInterneTaakComponent]
        })
            .overrideTemplate(CreateInterneTaakComponent, '')
            .compileComponents();

        save$ = new Subject<void>();

        fixture = TestBed.createComponent(CreateInterneTaakComponent);
        component = fixture.componentInstance;

        component.save$ = save$;
        component.disabled$ = of(false);
        component.pluginId = 'openklant';
        component.prefillConfiguration$ = of(emptyConfig as CreateInterneTaakConfig);
