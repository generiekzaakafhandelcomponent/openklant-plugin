...
@Component({
  selector: "update-digitaal-adres",
  imports: [AsyncPipe, FormModule, InputModule, NgIf, PluginTranslatePipeModule],
  standalone: true,
  templateUrl: "./update-digitaal-adres.component.html",
})
export class UpdateDigitaalAdresComponent implements FunctionConfigurationComponent, OnInit, OnDestroy {
