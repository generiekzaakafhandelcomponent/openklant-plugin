...
import {UpdateActorConfig} from '../../models/update-actor-config';
...
describe('UpdateActorComponent', () => {
    ...
    const emptyConfig = {
        uuid: '',
        resultPvName: '',
    } satisfies Partial<UpdateActorConfig>;
    const validConfig = {...emptyConfig, uuid: 'x', resultPvName: 'x'} satisfies Partial<UpdateActorConfig>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [UpdateActorComponent]
        })
            .overrideTemplate(UpdateActorComponent, '')
            .compileComponents();
        ...
        component.prefillConfiguration$ = of(emptyConfig as UpdateActorConfig);
