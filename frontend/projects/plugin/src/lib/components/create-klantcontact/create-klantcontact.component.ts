...
@Component({
    selector: 'openklant-create-klantcontact',
    standalone: true,
    imports: [
        AsyncPipe,
        FormModule,
    ...
    templateUrl: './create-klantcontact.component.html'
})
export class CreateKlantcontactComponent implements FunctionConfigurationComponent, OnInit, OnDestroy {
    @Input() save$: Observable<void>;
    @Input() disabled$: Observable<boolean>;
    @Input() pluginId: string;
    @Input() prefillConfiguration$?: Observable<CreateKlantcontactConfig>;
    @Output() valid: EventEmitter<boolean> = new EventEmitter<boolean>();
    @Output() configuration: EventEmitter<FunctionConfigurationData> = new EventEmitter<FunctionConfigurationData>();

    private saveSubscription!: Subscription;

    private readonly config$ = new BehaviorSubject<CreateKlantcontactConfig | null>(null);
    ...
    formValueChange(formOutput: FormOutput): void {
        const config = formOutput as CreateKlantcontactConfig;
        this.config$.next(config);
        this.handleValid(config);
    }

    private handleValid(formOutput: CreateKlantcontactConfig): void {
        const valid = 
            !!formOutput.kanaal &&
