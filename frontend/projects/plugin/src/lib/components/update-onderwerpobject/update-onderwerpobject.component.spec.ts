...
import {UpdateOnderwerpobjectComponent} from './update-onderwerpobject.component';
import {UpdateOnderwerpobjectConfig} from '../../models/update-onderwerpobject-config';

describe('UpdateOnderwerpobjectComponent', () => {
    let component: UpdateOnderwerpobjectComponent;
    let fixture: ComponentFixture<UpdateOnderwerpobjectComponent>;
    let save$: Subject<void>;

    const emptyConfig = {
        uuid: '',
        resultPvName: '',
    } satisfies Partial<UpdateOnderwerpobjectConfig>;
    const validConfig = {...emptyConfig, uuid: 'x', resultPvName: 'x'} satisfies Partial<UpdateOnderwerpobjectConfig>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [UpdateOnderwerpobjectComponent]
        })
            .overrideTemplate(UpdateOnderwerpobjectComponent, '')
            .compileComponents();

        save$ = new Subject<void>();

        fixture = TestBed.createComponent(UpdateOnderwerpobjectComponent);
        component = fixture.componentInstance;

        component.save$ = save$;
        component.disabled$ = of(false);
        component.pluginId = 'openklant';
        component.prefillConfiguration$ = of(emptyConfig as UpdateOnderwerpobjectConfig);
